...
func TestStringLikeHasPrefixTm(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			matcher := match.StringLikeHasPrefixTm(tm, tt.prefix)
...
func TestStringLikeHasPrefix(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			matcher := match.StringLikeHasPrefix[MyString](tt.prefix)
			matched, explanation := matcher.Match(tt.input)
...
func TestStringHasPrefix(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			matcher := match.StringHasPrefix(tt.prefix)
			matched, explanation := matcher.Match(tt.input)
